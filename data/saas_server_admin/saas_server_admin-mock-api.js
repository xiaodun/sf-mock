(function getApis() {
  ...
  return {
    "/v1/api/medic/manager/articles/uploadImg": {
      body: {
        data: {
          id: Math.random() + "",
    ...
    "/medic-admin/v1/api/medic/manager/articles/detail": {
      body: {
        status: 200,
        data: {
          articleLink: "",
          ...
          createTime: "",
          deptIds: [],
          id: "12121212121212121212121212121212121212121212121212121",
          likeNum: 0,
          properPerson: 0,
          publishTime: "",
          readNum: 0,
    ...
    "/medic-admin/v1/api/medic/manager/articles/findListByKeyword": {
      body: {
        status: 200,
        data: {
          pageNum: 1,
          ...
          rows: [
            ...
            },
            {
              ...
              createTime: "",
              deptIds: [],
              id: "21222222222222222222222222222222222222221212",
              likeNum: 0,
              properPerson: 0,
              publishTime: "",
              readNum: 0,
    ...
    "/medic-admin/v1/api/medic/manager/showlocation/list": {
      body: {
        status: 200,
        data: {},
      },
    ...
    "/api/gateway/doctor/d/admin/phoneConsult/getPhoneConsultDetailById": {
      body: {
        status: 200,
        message: "请求成功",
        data: {
          baseInfo: {
            ...
            patientSex: "男",
            patientAge: 11,
            patientPhone: "19946729936",
            doctorRealName: "周信勇",
            doctorId: "60016141e2960228c765ab9b",
            doctorWeiboId: null,
            departmentName: "中医科",
            phoneConsultId: "1624264313940914",
            orderPrice: 6,
            createTime: "2021-06-21 16:31:53",
            phoneConsultStatus: "评价完成",
          },
          questionInfo: {
            questionContent: "真实支付测试，医生金币导致情况测试",
            consultedPictures: ["https://pic.wenwo.com/fimg/40281545.jpg"],
            callBeginTime: "2021-06-21 17:00:00",
            callEndTime: "2021-06-21 18:00:00",
            phoneRecords: [
              {
                beginTime: "2021-06-21 16:33:13",
                endTime: "2021-06-21 16:35:00",
                talkTime: 100000,
              },
            ],
            consultDialogueResponses: [
              {
                id: "60d046dcbf6acb609f2244ed",
                createTime: "2021-06-21 15:59:24",
                content: "3333333333333333\n",
                pictureUrls: null,
                patientId: "60cc3942c5420b2beb0da8fb",
                doctorId: "60016141e2960228c765ab9b",
                quest: true,
              },
              {
                id: "60d04f35bf6acb609f2244fc",
                createTime: "2021-06-21 16:35:01",
                content: "通话时长  01:38",
                pictureUrls: null,
                patientId: "60cc3942c5420b2beb0da8fb",
                doctorId: "60016141e2960228c765ab9b",
          ...
          appriseDetail: {
            id: "60d0518c83c8c55f8398b113",
            grade: 5,
            appriseInfo: "谢谢百忙中及时解答了病人的苦恼",
          },
          refundInfo: null,
        },
      },
    ...
    "/api/gateway/doctor/d/admin/phoneConsult/getPhoneConsultAssembledStatus": {
      body: {
        status: 200,
        message: "请求成功",
        data: [
          ...
          { key: "CONSULTING", value: "咨询中" },
          { key: "CANCELED", value: "已取消" },
          { key: "FINISHED", value: "已完成" },
          { key: "TIMEOUT_CLOSED", value: "超时关闭" },
          { key: "APPRAISED", value: "评价完成" },
        ],
      },
    },

    "/api/gateway/doctor/d/admin/phoneConsult/getPhoneConsultPage": {
      body: {
        status: 200,
        message: "请求成功",
        data: {
          ...
          rows: [
            {
              phoneConsultId: "1624271518296711",
              patientRealName: "邹颖",
              patientPhone: "199****9936",
              doctorRealName: "周信勇",
              departmentName: "中医科",
              doctorId: "60016141e2960228c765ab9b",
              orderPrice: 0,
              createTime: "2021-06-21 18:31:58",
              phoneConsultStatus: "已取消",
            },
            {
              phoneConsultId: "1624269651369260",
              patientRealName: "唐珂",
              patientPhone: "150****8996",
              doctorRealName: "周信勇",
              departmentName: "中医科",
              doctorId: "60016141e2960228c765ab9b",
              orderPrice: 0,
              createTime: "2021-06-21 18:00:51",
              phoneConsultStatus: "已取消",
            },
            {
              phoneConsultId: "1624268391207833",
              patientRealName: "唐珂",
              patientPhone: "150****8996",
              doctorRealName: "姚鹏",
              departmentName: "新生儿科",
              doctorId: "60016140e2960228c765ab92",
              orderPrice: 0,
              createTime: "2021-06-21 17:39:51",
              phoneConsultStatus: "已取消",
            },
            {
              phoneConsultId: "1624267549314541",
              patientRealName: "王小二",
              patientPhone: "186****5150",
              doctorRealName: "hbj微博平台激活专用号",
              departmentName: "小儿内科",
              doctorId: "5fc495a297a1c000067d4560",
              orderPrice: 6,
              createTime: "2021-06-21 17:25:49",
              phoneConsultStatus: "已取消",
            },
            {
              phoneConsultId: "1624267305998937",
              patientRealName: "郑永乐患者测试",
              patientPhone: "188****8908",
              doctorRealName: "郑永乐",
              departmentName: "中医科",
              doctorId: "6093a5507d03a75efb69d260",
              orderPrice: 0,
              createTime: "2021-06-21 17:21:45",
              phoneConsultStatus: "已取消",
            },
            {
              phoneConsultId: "1624266637333300",
              patientRealName: "王小二",
              patientPhone: "186****5150",
              doctorRealName: "hbj微博平台激活专用号",
              departmentName: "小儿内科",
              doctorId: "5fc495a297a1c000067d4560",
              orderPrice: 6,
              createTime: "2021-06-21 17:10:37",
              phoneConsultStatus: "已取消",
            },
            {
              phoneConsultId: "1624264313940914",
            ...
            {
              phoneConsultId: "1624263901011852",
              patientRealName: "邹颖",
              patientPhone: "199****9936",
              doctorRealName: "周信勇",
              departmentName: "中医科",
              doctorId: "60016141e2960228c765ab9b",
              orderPrice: 0,
              createTime: "2021-06-21 16:25:01",
              phoneConsultStatus: "已取消",
            },
            {
              phoneConsultId: "1624262533138967",
              patientRealName: "邹颖",
              patientPhone: "199****9936",
              doctorRealName: "周信勇",
              departmentName: "中医科",
              doctorId: "60016141e2960228c765ab9b",
              orderPrice: 6,
              createTime: "2021-06-21 16:02:13",
              phoneConsultStatus: "已取消",
            },
            {
              phoneConsultId: "1624262352559462",
              patientRealName: "王小二",
              patientPhone: "186****5150",
              doctorRealName: "hbj微博平台激活专用号",
              departmentName: "小儿内科",
              doctorId: "5fc495a297a1c000067d4560",
              orderPrice: 6,
              createTime: "2021-06-21 15:59:12",
              phoneConsultStatus: "评价完成",
            },
          ],
          nextPageNum: 2,
    ...
    "/medic-admin/v1/api/medic/manager/articles/addOrUpdate": {
      body: {
        status: 30100130,
        message: "文章内容包含敏感内容，请检查，内容保存失败",
        data: {
          id: null,
          failErrors: [
            "法轮功",
            ...
            "法轮功",
            "肿瘤",
            "https://img2.baidu.com/it/u=1956622302,1895131241&fm=26&fmt=auto&gp=0.jpg",
            "https://img2.baidu.com/it/u=1956622302,1895131241&fm=26&fmt=auto&gp=0.jpg",
            "https://img2.baidu.com/it/u=1956622302,1895131241&fm=26&fmt=auto&gp=0.jpg",
          ],
        },
